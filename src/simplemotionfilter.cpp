...
void SimpleMotionFilter::boxUpdate(kuri_mbzirc_challenge_1::TrackerData& data, float step)
{
  prev = current;
  current = data;
  timestep = step;
...
kuri_mbzirc_challenge_1::TrackerData SimpleMotionFilter::interpolate(float step)
{
  ...
  kuri_mbzirc_challenge_1::TrackerData newData;
